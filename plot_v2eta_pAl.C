...
void plot_v2eta_pAl()
{
  ...
  TFile* infile = TFile::Open("pal200_all.root");
  ...
  c1->Print("Figures/v2eta_zbins_pal200.png");
  c1->Print("Figures/v2eta_zbins_pal200.pdf");
  ...
  c1->Print("Figures/v2eta_zcheck_pal200.png");
  c1->Print("Figures/v2eta_zcheck_pal200.pdf");
  ...
  c1->Print("Figures/v2eta_corr_pal200.png");
  c1->Print("Figures/v2eta_corr_pal200.pdf");
  ...
  c1->Print("Figures/v2eta_clean_pal200.png");
  c1->Print("Figures/v2eta_clean_pal200.pdf");

  // -------------------------------------------------------------
  // --- now make the final plot with the eta dependent correction

  TFile* corrfile = TFile::Open("ampt_vneta_correction.root");
  TH1D* v2eta_corr = (TH1D*)corrfile->Get("v2eta_correction_dAu200"); // need one for pal200, but this should be pretty close
  ...
  latt.DrawLatex(0.30, 0.87, "PHENIX");
  latt.DrawLatex(0.56, 0.87, "p+Al #sqrt{s_{_{NN}}} = 200 GeV");
  latt.DrawLatex(0.56, 0.80, "EP: -3.9 < #eta < -3.1");

  c1->Print("Figures/v2eta_final_pal200.png");
  c1->Print("Figures/v2eta_final_pal200.pdf");

  TFile* outfile = TFile::Open("pal200_v2eta.root","recreate");
  outfile->cd();
